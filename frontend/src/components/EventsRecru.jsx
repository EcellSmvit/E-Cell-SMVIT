  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[#111111] px-5 py-16 text-white sm:px-10 sm:py-24">
      <div className="mx-auto max-w-6xl">
          ...
          {events.map((event, idx) => (
            ...
            >
              <div className="relative h-60 overflow-hidden bg-[#222222]">
                ...
                <div className="absolute right-4 top-4 flex h-9 w-9 translate-y-2 items-center justify-center rounded-full bg-[#6D4CFF] text-white opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
        ...
        <div className="mt-10 flex flex-col justify-between gap-5 rounded-2xl bg-[#6D4CFF] p-6 sm:flex-row sm:items-center sm:p-7">
