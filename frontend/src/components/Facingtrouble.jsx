  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#111111] px-5 py-16 text-white sm:px-10 sm:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F1EFE9] transition-colors group-hover:bg-[#E21B12] group-hover:text-white">
                <Mail size={18} />
              </div>
        ...
        {/* ================= BOTTOM CTA ================= */}
        <div className="mt-5 flex flex-col items-start justify-between gap-4 rounded-2xl bg-[#E21B12] px-6 py-5 text-white sm:flex-row sm:items-center sm:px-7">
