  ...
  return (
    <div>
      <div className="relative z-10 pointer-events-none w-full h-screen flex justify-center items-center flex-col">
        <h1 className='text-white font-bold text-xl'>E-CELL SMVIT Presents</h1>
        <h1
        ...
        <div className='flex items-center justify-center gap-6 text-white font-bold text-xl drop-shadow-2xl select-none'>
          Powered by
