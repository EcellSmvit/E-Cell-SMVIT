...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto max-w-md bg-black shadow-xl w-[24rem] rounded-4xl ${stepCircleContainerClassName}`}
        style={{ border: "1px solid #222" }}
      >
        <div className={`flex items-center p-8 w-full ${stepContainerClassName}`}>
