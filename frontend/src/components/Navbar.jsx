...
function Navbar() {
  ...
  <div className="hidden md:flex">
    <ul className='flex items-center justify-center gap-6 md:gap-8 text-sm md:text-base'>
  ...
  <div className="space-x-2 md:space-x-4 flex items-center">
    <button className="px-4 py-1.5 text-xs md:text-sm font-medium text-[#4F46E5] bg-white">
      Login
    </button>

    <button className="px-4 py-1.5 text-xs md:text-sm font-medium text-white transition-all duration-200 bg-[#4F46E5] rounded-lg hover:bg-gray-200">
      Signup
    </button>
  </div>
</div>
